# Contributing to ngx-build

We would love for you to contribute to ngx-build and help make it even better than it is today!
...
If you find a bug in the source code, you can help us by submitting an issue to our [GitHub Repository](https://github.com/push-based/ngx-build).
...
<type>(<scope>): <short summary>
  ...
  |       |
  |       +-- Commit Scope: ngx-chunks|docs|demo|ci
  |
