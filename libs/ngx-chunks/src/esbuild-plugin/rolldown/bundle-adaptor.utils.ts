...
export function rolldownToEsbuildOutputs(
  rollupOutput: RolldownOutput['output'],
  { outputs }: Metafile
) {
  ...
  rollupOutput
    ...
    .forEach((output) => {
      ...
      if (output.facadeModuleId) {
        newMetafileOutputs[output.fileName].entryPoint =
          outputs[output.facadeModuleId].entryPoint;
      }
